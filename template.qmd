...
This feature is not yet supported by Quarto in the HTML output (v. 1.3, see [issue #555](https://github.com/quarto-dev/quarto-cli/issues/555)).
...
- Tables do not support equations in HTML ([issue #555](https://github.com/quarto-dev/quarto-cli/issues/555))
...
- Figure width is not properly managed in two-column PDF documents [issue #855](https://github.com/quarto-dev/quarto-cli/issues/855))
