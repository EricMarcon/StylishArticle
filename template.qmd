...
- Language-specific formats are only partially applied in LaTeX: in the example above, French quotes are not applied.
The format of the quotes follows the main language of the document.
